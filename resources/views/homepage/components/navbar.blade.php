<nav style="backdrop-filter: blur" class="navbar fixed-top bg-white border border-bottom shadow-sm navbar-expand-lg">
  <div class="container align-items-center">
    ...
    <!-- <div class="overflow-hidden px-1 d-none d-lg-flex w-100 mx-5 align-items-center border border-3 rounded-4">
      <input style="outline: 0;" class="border-0 p-3 flex-grow-1 w-100 fs-6
          type=" text" placeholder="Search" />
      <button class="rounded-pill border-0 w-100 d-flex justify-content-center align-items-center bg-white"
        style="height: 42px; width: 42px;">
        <svg width="48" height="48" viewBox="0 0 48 49" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect y="0.106689" width="48" height="48" rx="24" fill="#724CB4" />
          <path
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="navbarOffcanvas" aria-labelledby="navbarOffcanvasLabel">
      ...
      <div class="offcanvas-body">
        <ul class="ms-3 navbar-nav gap-2 text-center text-lg-start">
          ...
          <li class="nav-item">
            <a class="btn py-2 px-4 bg-primary text-white fw-bold" href="{{route('login')}}">Masuk</a>
          </li>
          <li class="nav-item">
            <a class="btn py-2 px-4 bg-primary-dark text-white fw-bold" href="{{route('register')}}">Daftar</a>
          </li>
        </ul>
      </div>
    </div>
