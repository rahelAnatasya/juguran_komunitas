<nav
      ...
      class="navbar fixed-top bg-white border border-bottom shadow-sm navbar-expand-lg"
    >
      <div class="container align-items-center">
        <a
          class="navbar-brand lh-1 color-primary-dark d-flex align-items-center fw-bold"
          href="/"
        >
          <img
            style="height: 70px"
            src="/assets/images/logo/icon-juguran-komunitas.png"
            alt="Logo"
          />
          <span
            >JUGURAN <br />
        ...
        <div
          class="overflow-hidden px-1 d-none d-lg-flex w-100 mx-5 align-items-center border border-3 rounded-4"
        >
          <input style="outline: 0;" class="border-0 p-3 flex-grow-1 w-100 fs-6
        ...
        >
          <div class="offcanvas-header">
            ...
            <button
              type="button"
              class="btn-close mx-2 my-3 text-reset"
          ...
          <div class="offcanvas-body">
            <ul class="ms-3 navbar-nav gap-2 text-center text-lg-start">
              <li class="nav-item">
                <a
                  class="nav-link color-primary fw-semibold border-bottom mx-auto border-3 color-primary-dark"
              ...
              <li class="nav-item">
                <a class="btn py-2 px-4 bg-primary text-white fw-bold" href="#"
                  >Masuk</a
                >
              </li>
              <li class="nav-item">
                <a
                  class="btn py-2 px-4 bg-primary-dark text-white fw-bold"
                  href="#"
                  >Daftar</a
                >
              </li>
