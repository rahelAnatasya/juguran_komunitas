  ...
  <div class="container">
    ...
    <div class="col-12 col-md-4" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
      ...
      <div class="position-relative">
        <span class="badge bg-danger text-white position-absolute top-0 start-0 m-3" data-aos="fade-right"
        data-aos-delay="400">EXPIRED</span>
        <img src="{{ asset('assets/images/UIUX.png') }}" class="card-img-top" alt="Event Image" data-aos="zoom-in"
        data-aos-delay="300">
      </div>
      <div class="card-body" data-aos="fade-up" data-aos-delay="500">
        ...
        <a href="#" class="btn btn-purple w-100" data-aos="fade-up" data-aos-delay="600">Lihat Detail</a>
      </div>
      </div>
    </div>
    </div>
