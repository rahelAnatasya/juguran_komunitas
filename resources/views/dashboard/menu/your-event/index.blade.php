        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-wrap justify-content-between gap-3">
                    ...
                    <div>
                        <button type="button" class="btn btn-success" data-bs-target="#create-event" data-bs-toggle="modal"> Buat Acara Kamu</button>
                    </div>
                </div>
            </div>
            <div>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <input type="text" id="nameEvent" name="nameEvent" class="form-control" placeholder="Masukkan nama acara">
                        </div>
                        <div class="mb-3">
